...
interface InformationBusinnesPageProps {
  params: {
    lng: string;
  };
}

const InformationBusinnesPage = ({ params }: InformationBusinnesPageProps) => {
  const { lng } = params;
  const { t } = useTranslation(lng, "information", InformationBusinnesPage);
...
export default InformationBusinnesPage;
